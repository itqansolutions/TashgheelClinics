...
const NAV_ITEMS: NavItem[] = [
  ...
  { label: 'Doctors',      path: '/doctors',     icon: Stethoscope,    roles: ['Admin', 'Reception', 'Receptionist'] },
  { label: 'Schedule',     path: '/doctors/schedule', icon: Clock,     roles: ['Admin', 'Reception', 'Receptionist'] },
